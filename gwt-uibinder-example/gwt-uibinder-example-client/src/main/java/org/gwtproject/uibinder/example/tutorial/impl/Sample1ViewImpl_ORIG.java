 ...
 *
 */
public class Sample1ViewImpl_ORIG implements Sample1View_ORIG {

  //@UiTemplate
  interface MyUiBinder extends UiBinder<DivElement, Sample1ViewImpl_ORIG> {
  }
